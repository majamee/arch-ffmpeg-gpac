...
# informing users, how they can achieve the same goal in under 30 MB
echo -e "\nThis project is getting deprecated!\nPlease check http://alpine-dash-hls.gq/ for a streamlined version (< 30 MB) of this project and its successor :)"
